...
class ROIRelationHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None, logger=None):
        ...
        if not self.training:
            ...
            return roi_features, result, {},  (refine_logits, rel_pair_idxs, relation_logits)
        ...
        return roi_features, proposals, output_losses, (refine_logits, rel_pair_idxs, relation_logits)
