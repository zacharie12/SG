...
# -----------------------------------------------------------------------------#
_C.LISTENER = CN()
_C.LISTENER.IMAGE_SIZE = 224
_C.LISTENER.NODE_SIZE = 151
_C.LISTENER.EDGE_SIZE = 51
_C.LISTENER.CNN_OUTPUT = 200
_C.LISTENER.GNN_OUTPUT = 200
_C.LISTENER.LOSS_COEF = 2.5
_C.LISTENER.CNN = 'ResNet'
_C.LISTENER.GNN = 'MetaGNN'
_C.LISTENER.END = 'CosineDistance'

_C.LISTENER.LR = 0.002 / 40
_C.LISTENER.WEIGHT_DECAY = 0.0
_C.LISTENER.CLIP_VALUE = 0.5
_C.LISTENER_DIR = "."

_C.LISTENER.HTML = False

_C.LISTENER.JOINT = False