...
from maskrcnn_benchmark.engine.inference import inference, listener_test_inference
...
def main():
    ...
    listener_checkpointer = Checkpointer(cfg, listener, save_dir=listener_dir)
    _ = checkpointer.load(cfg.MODEL.WEIGHT)
    _ = listener_checkpointer.load("")
