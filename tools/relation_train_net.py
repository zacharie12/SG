...
def train(cfg, local_rank, distributed, logger):
    ...
    for iteration, (images, targets, _) in enumerate(train_data_loader, start_iter):
        ...
        print('TYPE IMAGE LIST: ', type(images))
        print('SIZE IMAGE LIST: ', images.tensors.size())
        print('IMAGE LIST ORIG SIZES: ', images.image_sizes)
        loss_dict, sgs = model(images, targets)
